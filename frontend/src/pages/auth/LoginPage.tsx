      ...
      <div className="hidden lg:flex w-[44%] bg-slate-900 flex-col p-10 relative overflow-hidden flex-shrink-0">
        ...
        <div className="mb-auto pt-16">
          ...
          <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
            Book an appointment at MediCare+ in minutes. Choose your specialist,
            pick your slot, and leave the rest to us.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="relative">
                <i
                  className="ti ti-user absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-base pointer-events-none"
                  aria-hidden="true"
                />
                <input
                  type="text"
            ...
            <div>
              ...
              <div className="relative">
                <i
                  className="ti ti-lock absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-base pointer-events-none"
                  aria-hidden="true"
                />
                <input
