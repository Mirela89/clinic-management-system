      ...
      <div className="hidden lg:flex w-[44%] bg-slate-900 flex-col p-10 relative overflow-hidden flex-shrink-0">
        ...
        <div className="mb-auto pt-16">
          ...
          <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
            Create your account and book your first appointment at MediCare+ in
            minutes.
          </p>
        </div>
          ...
          {STEPS_INFO.map((step, i) => (
            <div key={i} className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-lg bg-slate-800 flex items-center justify-center flex-shrink-0">
                <i
                  className={`ti ${step.icon} text-blue-400`}
                  style={{ fontSize: "14px" }}
                  aria-hidden="true"
                />
              </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="flex lg:hidden items-center gap-2 justify-center mb-6">
            <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">
              <i
                className="ti ti-heart-rate-monitor text-white text-base"
                aria-hidden="true"
              />
            </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <div>
              ...
              <div className="relative">
                <i
                  className="ti ti-at absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm pointer-events-none"
                  aria-hidden="true"
                />
                <input
                  name="username"
            ...
            <div>
              ...
              <div className="relative">
                <i
                  className="ti ti-mail absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm pointer-events-none"
                  aria-hidden="true"
                />
                <input
                  name="email"
            ...
            <div>
              ...
              <div className="relative">
                <i
                  className="ti ti-phone absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm pointer-events-none"
                  aria-hidden="true"
                />
                <input
                  name="phone"
            ...
            <div>
              ...
              <div className="relative">
                <i
                  className="ti ti-lock absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm pointer-events-none"
                  aria-hidden="true"
                />
                <input
                  name="password"
                ...
                >
                  <i
                    className={`ti ${showPassword ? "ti-eye-off" : "ti-eye"} text-sm`}
                    aria-hidden="true"
                  />
                </button>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <i
                  className="ti ti-lock-check absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm pointer-events-none"
                  aria-hidden="true"
                />
                <input
                ...
                >
                  <i
                    className={`ti ${showConfirm ? "ti-eye-off" : "ti-eye"} text-sm`}
                    aria-hidden="true"
                  />
                </button>
              </div>
              {form.confirmPassword &&
                form.password !== form.confirmPassword && (
                  <p className="text-xs text-red-400 mt-1 flex items-center gap-1">
                    <i
                      className="ti ti-alert-circle text-xs"
                      aria-hidden="true"
                    />
            ...
            {success && (
              <div className="bg-emerald-50 border border-emerald-100 text-emerald-600 text-xs sm:text-sm rounded-xl px-3 py-2.5 flex items-center gap-2">
                <i
                  className="ti ti-circle-check text-base flex-shrink-0"
                  aria-hidden="true"
                />
                {success}
              </div>
          ...
          <p className="text-center text-xs text-slate-300 mt-4">
            ...
            <span className="text-slate-400 cursor-pointer hover:underline">
              Terms of Service
            </span>{" "}
            and{" "}
            <span className="text-slate-400 cursor-pointer hover:underline">
